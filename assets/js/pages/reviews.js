        ...
        React.createElement('div', { className: 'animate-fade-in min-h-screen' },
            React.createElement('div', { className: 'max-w-7xl mx-auto px-4 py-20' },
                React.createElement('div', { className: 'text-center mb-16' },
                    React.createElement('h1', { className: 'font-display text-5xl mb-4' }, t('reviews.title')),
                    React.createElement('div', { className: 'flex justify-center gap-8 mt-8' },
                        React.createElement('div', null,
                            ...
                            React.createElement('div', { className: 'text-sm text-gray-600' }, t('home.reviewsTitle'))
                        )
                    )
                ),
                        ...
                        ...reviewsData.map(review =>
                            React.createElement('div', {
                                ...
                                React.createElement('div', { className: 'flex justify-between items-start mb-4' },
                                    React.createElement('div', null,
                                        React.createElement('div', { className: 'font-bold' }, getField(review, 'name')),
                                ...
                                React.createElement('p', { className: 'italic mb-2' }, `"${getField(review, 'comment')}"`),
